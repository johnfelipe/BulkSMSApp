            ...
            if (ModelState.IsValid)
            {
                ...
                try
                {
                    ...
                    else
                    {
                        ...
                        {
                            if (error.Contains("Name " + user.UserName + " is already taken") || error.Contains("Email " + user.Email + " is already taken"))
                            {
                                Danger("El Email ingresado ya está registrado, por favor provea un Email diferente", true);
                                ViewBag.RolID = new SelectList(context.Roles.ToList(), "Name", "Name");
                                return View(model);
                            }
                        }
        ...
        public async Task<ActionResult> ForgotPassword(ForgotPasswordViewModel model)
        {
            if (ModelState.IsValid)
            {
                try
                {
                    ...
                    if (user == null)
                    {
                        Danger("El Email ingresado no corresponde a un usuario registrado", true);
                        //return View();
                    ...
                    else
                    {
                        ...
                        Information("Por favor revisa tu Email y sigue las instrucciones para reestablecer tu Contraseña");
                        return RedirectToAction("Login");
                    }
            ...
            {
                Warning("Error de Validación, verifica los datos e intenta nuevamente", true);
            }
            return View(model);
        }
        ...
        public async Task<ActionResult> ResetPassword(ResetPasswordViewModel model)
        {
            ...
            try
            {
                ...
                if (user == null)
                {
                    ...
                    Danger("El email ingresado no es válido");
                    return View(model);
                }
                else
                {
                    ...
                    if (model.Code == null)
                    {
                        Danger("El enlace de recuperación de contraseña ha expirado, solicita uno nuevo para reestablecer tu contraseña");
                        return RedirectToAction("ForgotPassword", "Account");
                    }
                    if (result.Succeeded)
                    {

                        Information("Tu Contraseña ha sido reestablecida correctamente, ya puedes iniciar sesión");
